            ...
            <form action="{{route('basket.finish')}}" class="order__body-content">
                ...
                <div class="step-tabs-wrapper mb-40">
                    ...
                    <div class="step-tabs-tab order__tab" id="form-tab-02">
                        ...
                        <p class="mb-40">
                            Обратите внимание, заказы принимаются в обработку с 9:00 до 16:00 <br>
                            При заказе до 16:00 доставка осуществляется на следующий день. <br>
                            При заказе после 16:00 доставка осуществляется через день. <br>
